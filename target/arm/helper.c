...
static const ARMCPRegInfo v8_cp_reginfo[] = {
    ...
    { .name = "APPLE_UNKN_3_4_15_0_5", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 4, .crn = 15, .crm = 0, .opc2 = 5,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_4_15_0_5) },
    ...
    { .name = "APPLE_UNKN_3_4_15_10_6", .state = ARM_CP_STATE_AA64, // some timer, replaces cntvct_el0 on M1
      ...
      .access = PL0_R, .type = ARM_CP_NO_RAW | ARM_CP_IO,
      .accessfn = gt_vct_access, .readfn = gt_virt_cnt_read },
    { .name = "APPLE_UNKN_3_4_15_12_5", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 4, .crn = 15, .crm = 12, .opc2 = 5,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_4_15_12_5) },
    { .name = "APPLE_UNKN_3_5_15_0_0", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 5, .crn = 15, .crm = 0, .opc2 = 0,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_5_15_0_0) },
    ...
    { .name = "APPLE_UNKN_3_5_15_1_1", .state = ARM_CP_STATE_AA64,
      ...
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_5_15_3_1) },
    ...
    { .name = "APPLE_UNKN_3_6_15_1_2", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 1, .opc2 = 2,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_1_2) },
    ...
    { .name = "APPLE_UNKN_3_6_15_8_1", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 8, .opc2 = 1,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_8_1) },
    { .name = "APPLE_UNKN_3_6_15_8_2", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 8, .opc2 = 2,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_8_2) },
    ...
    { .name = "APPLE_UNKN_3_6_15_10_3", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 10, .opc2 = 3,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_10_3) },
    { .name = "APPLE_UNKN_3_6_15_10_4", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 10, .opc2 = 4,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_10_4) },
    { .name = "APPLE_UNKN_3_6_15_10_5", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 10, .opc2 = 5,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_10_5) },
    { .name = "APPLE_UNKN_3_6_15_10_6", .state = ARM_CP_STATE_AA64,
      .opc0 = 3, .opc1 = 6, .crn = 15, .crm = 10, .opc2 = 6,
      .resetvalue = 0,
      .access = PL1_RW, .fieldoffset = offsetof(CPUARMState, cp15.apple_3_6_15_10_6) },
